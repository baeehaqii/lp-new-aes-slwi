...
export const metadata: Metadata = {
  title: "Sapphire Aesthetic Slawi - Hunian Modern di Slawi",
  description: "Temukan properti impian Anda di Sapphire Aesthetic Slawi, hunian modern dengan lokasi strategis di Jl. Merapi, Dukuhwringin, Kecamatan Slawi, Kabupaten Tegal dengan fasilitas lengkap dan Smart Door Lock",
  icons: {
