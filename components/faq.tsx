  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "Lokasi Sapphire Aesthetic Slawi di Jalan Merapi, Desa Dukuhwringin, Kecamatan Slawi, Kabupaten Tegal. Lokasinya dekat dengan fasilitas umum. Hanya berjarak 2 menit dari Alun-Alun Hanggawana Slawi, 6 menit dari Terminal Dukuh Salam, 7 menit dari Mutiara Cahaya Mall, 2 menit dari SMAN 2 Slawi, dan 5 menit dari RS Dr. Soeselo.",
    },
    {
      question: "Apa saja fasilitas umum yang disediakan di dalam Sapphire Aesthetic Slawi?",
      answer:
        "Di Sapphire Aesthetic Slawi, kami menghadirkan lingkungan dengan fasilitas modern dan nyaman. Kami menyediakan fasilitas olahraga di sekitar area perumahan. Selain itu, kami juga menyediakan area terbuka hijau atau green area yang memberikan kesejukan dan ketenangan sehingga cocok digunakan untuk tempat rekreasi Anda. Kami juga mengutamakan keamanan dengan one gate system dan penjagaan dari sekuriti selama 24 jam untuk menjaga kawasan tetap aman.",
    },
    {
      question: "Apakah rumah di Sapphire Aesthetic Slawi sudah memiliki sertifikat hak milik (SHM)?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Mengenai legalitas di Sapphire Aesthetic Slawi, semua sudah lengkap dan aman, Bapak/Ibu. Properti di sini dilengkapi Sertifikat Hak Milik (SHM), jadi kepemilikannya jelas atas nama pembeli. Izin bangunannya juga sudah ada melalui Persetujuan Bangunan Gedung (PBG), artinya bangunan sudah sesuai aturan dan aman.",
    },
    {
    ...
    {
      question: "Apakah rumah di Sapphire Aesthetic Slawi sudah memiliki PBG?",
      answer:
        "Rumah di Sapphire Aesthetic Slawi sudah memiliki Persetujuan Bangunan Gedung (PBG), jadi Anda tidak perlu khawatir soal legalitas bangunan ini. PBG ini memastikan bahwa proses pembangunan sudah sesuai dengan peraturan yang berlaku, sehingga hunian di sini aman dan sah untuk ditinggali, maupun sebagai investasi jangka panjang.",
    },
    {
    ...
    <section id="faq" className="faq-section">
      <div className="container">
        <div className="faq-header">
          <h2 className="faq-title">Pertanyaan Umum Sapphire Aesthetic Slawi</h2>
